...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-gb">
  ...
  <div class="w3-padding-large" id="main">
    ...
    <!-- Posts Section -->
    <form action="" method="post" id="viewPost" name="ViewPost">
      <table>
        <thead>
          <tr>
            <th colspan="4"><h3>Viewing the Journey Information</h3><br></th>
          </tr>
        </thead>
        <tbody>
          <?php
          $connect = mysqli_connect($host, $user, $passwd, $dbName);
          $result = mysqli_query($connect, "SELECT * FROM Journeys WHERE Journey_ID = '$journeyid'");
