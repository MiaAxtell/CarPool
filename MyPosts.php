  ...
  <div class="w3-padding-large" id="main">
    ...
    <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="posts">
      ...
      <hr style="width:200px" class="w3-opacity">
        <table>
          <form action="EditPost.php" method="post" id="editPost" name="EditPost">
            <tbody>
              <tr>
              ...
              <?php
					...
					$result = mysqli_query($connect, "SELECT * FROM Journeys WHERE Organiser_ID = '$username'");
              ...
              <tr>
                <td colspan="7">
                  <input type='submit' class="button" name="editPost" value='Edit Post' onclick="editPost">
                </td>
              </tr>
            </tbody>
          </form>
