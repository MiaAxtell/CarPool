...
define('URLFORM', 'https://stuweb.cms.gre.ac.uk/~am642/CarPool/EditImage.php');
define('URLLIST', 'https://stuweb.cms.gre.ac.uk/~am642/CarPool/imageDeletedbi.php');
...
<head>
<title>CarPool | Delete Image</title>
...
if ( isset($_POST['yesButton']) ) {
  if ( !($link = mysqli_connect($host, $user, $passwd, $dbName)) ) {
    ...
    if ( !mysqli_query($link, $query) ) {
      ...
      echo "<p>You have now successfully deleted this image\n" .
      '<br /><br />Click here to ' .
...
echo '<form action="' . URLFORM . '" method="post"><p>' . "\n" .
      ...
      '<input type="hidden" name="image_alt" value="' . $image_alt . '" />' . "\n" .
      '<input type="hidden" name="img" value="' . $img . '" />' . "\n" ;


	// report input data back to the user
	echo '<h2>Please check these are the details you wish to delete:</h2><p>' .
	  "\n Image ID: $image_ID<br />" .
	  "\n Journey ID: $journey_ID<br />" .
	  "\n Image Type: $image_type<br />" .
	  "\n Image Name: $image_name<br />" .
	  "\n Image Description: $image_alt<br />" .
	  "\n Image: $img<br />" ;

	?>

	<p>Please confirm that you wish to delete this record:<br />
