...
define('URLLIST', 'https://stuweb.cms.gre.ac.uk/~am642/CarPool/deletePostdbi.php');
...
<head>
<title>CarPool | Delete Post</title>
...
if ( isset($_POST['yesButton']) ) {
  if ( !($link = mysqli_connect($host, $user, $passwd, $dbName)) ) {
    ...
    $query = "DELETE FROM `Journeys` WHERE `Journey_ID`='$journey_ID'";
    if ( !mysqli_query($link, $query) ) {
      echo '<p>Insert error</p>';
    } else {
      echo "<p>You have now successfully deleted this post\n" .
      '<br /><br />Click here to ' .
