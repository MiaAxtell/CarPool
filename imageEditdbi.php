...
define('URLLIST', 'https://stuweb.cms.gre.ac.uk/~am642/CarPool/imageEditdbi.php');
...
if ( isset($_POST['yesButton']) ) {
  if ( !($link = mysqli_connect($host, $user, $passwd, $dbName)) ) {
    ...
    $query = "UPDATE `Images` SET `Image_Name`='$image_name',`Image_alt`='$image_alt' WHERE `Image_ID`='$image_ID'";
